...
namespace StorageAccount.Repository
{
    ...
    {
        public static string connectionString="DefaultEndpointsProtocol=https;AccountName=madhustorgaccount;AccountKey=uybYfRe7DCkumrWq9+apVknF69jj+5s0Pw3B74rr+WFtt7LCpLxdPpCLJ9xLULNXimNMku0hk6e2+AStTTgGVg==;EndpointSuffix=core.windows.net";
